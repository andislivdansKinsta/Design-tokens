...
public enum StyleDictionarySize {
    ...
    public static let 3xSmall = roundTo(roundTo(roundTo(roundTo(CGFloat(256.00) / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) /2,0) *2
    ...
    public static let large = roundTo(roundTo(CGFloat(256.00) * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2
    public static let medium = roundTo(CGFloat(256.00) * CGFloat(19.20) /2,0) *2
    public static let regular = CGFloat(256.00)
    public static let scale = CGFloat(19.20)
    public static let small = roundTo(CGFloat(256.00) / CGFloat(19.20) / 2,0) *2
    public static let xLarge = roundTo(roundTo(roundTo(CGFloat(256.00) * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2
    public static let xSmall = roundTo(roundTo(CGFloat(256.00) / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) / 2,0) *2
    public static let xxLarge = roundTo(roundTo(roundTo(roundTo(CGFloat(256.00) * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2 * CGFloat(19.20) /2,0) *2
    public static let xxSmall = roundTo(roundTo(roundTo(CGFloat(256.00) / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) / 2,0) *2 / CGFloat(19.20) / 2,0) *2
}
